...
public class LeastWordyAnalyzerTest {
    @InjectMocks
    private LeastWordyAnalyzer leastWordyAnalyzer;
    ...
    public void test_analyze_uniqueExist() {
        ...
        speechDataList.add(SpeechData.builder().speaker("speaker-1").topic("topic-1").date(now).wordCount(5).build());
        speechDataList.add(SpeechData.builder().speaker("speaker-2").topic("topic-2").date(now).wordCount(3).build());
        speechDataList.add(SpeechData.builder().speaker("speaker-5").topic("topic-5").date(now).wordCount(15).build());
        ...
        speechDataList.add(SpeechData.builder().speaker("speaker-4").topic("topic-3").date(now).wordCount(9).build());
        speechDataList.add(SpeechData.builder().speaker("speaker-5").topic("topic-5").date(now).wordCount(66).build());

        assertEquals("speaker-2", leastWordyAnalyzer.analyze(speechDataList));
    }
    ...
    public void test_analyze_uniqueNotExist() {
        ...
        assertEquals(null, leastWordyAnalyzer.analyze(speechDataList));
    }
}
